CREATE VIEW dbo.CustomersStatsTotal
AS
SELECT dbo.Orders.CustomerId, ROUND(SUM(dbo.OrderDetails.Quantity * ISNULL(dbo.Menu.UnitPrice, dbo.Products.DefaultPrice) - dbo.OrderDetails.DiscountAmount), 2) AS totalPrice,
...
FROM     dbo.OrderDetails INNER JOIN
                  ...
                  dbo.Discounts ON dbo.OrderDetails.DiscountId = dbo.Discounts.DiscountId CROSS JOIN
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[49] 4[12] 2[35] 3) )"
      End
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "Discounts"
            ...
            TopColumn = 0
         End
         Begin Table = "IndividualCustomer"
            Begin Extent = 
               Top = 154
               Left = 834
               Bottom = 317
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 12
         Column = 1440
', 'SCHEMA', 'dbo', 'VIEW', 'CustomersStatsTotal'
go

exec sp_addextendedproperty 'MS_DiagramPane2', N'         Alias = 900
         Table = 1176
         Output = 720
         Append = 1400
         NewValue = 1170
...
exec sp_addextendedproperty 'MS_DiagramPaneCount', 2, 'SCHEMA', 'dbo', 'VIEW', 'CustomersStatsTotal'
go

grant select on CustomersStatsTotal to manager
go
