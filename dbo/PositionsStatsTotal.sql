CREATE VIEW PositionsStatsTotal AS
SELECT Pos.PositionName, COUNT(DISTINCT O.OrderId) AS NumberOfOrders, SUM((OD.Quantity * ISNULL(M.UnitPrice, P.DefaultPrice))
...
grant select on PositionsStatsTotal to manager
go
