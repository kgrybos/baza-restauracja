CREATE VIEW dbo.CustomerStatsWeekly
AS
SELECT dbo.Orders.CustomerId, YEAR(dbo.Orders.OrderDate) AS year, DATEPART(week, dbo.Orders.OrderDate) AS week, ROUND(SUM(dbo.OrderDetails.Quantity * ISNULL(dbo.Menu.UnitPrice, dbo.Products.DefaultPrice) 
...
GROUP BY dbo.Orders.CustomerId, YEAR(dbo.Orders.OrderDate), DATEPART(week, dbo.Orders.OrderDate)
go
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 12
         ...
         Or = 1350
         Or = 1350
         Or =', 'SCHEMA', 'dbo', 'VIEW', 'CustomerStatsWeekly'
go
...
exec sp_addextendedproperty 'MS_DiagramPane2', N' 1350
   ...
   End
End
', 'SCHEMA', 'dbo', 'VIEW', 'CustomerStatsWeekly'
go

exec sp_addextendedproperty 'MS_DiagramPaneCount', 2, 'SCHEMA', 'dbo', 'VIEW', 'CustomerStatsWeekly'
go

grant select on CustomerStatsWeekly to manager
go
