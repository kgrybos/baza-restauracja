CREATE VIEW dbo.ProductWeeklyStatistics
AS
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', 'dbo', 'VIEW', 'ProductWeeklyStatistics'
go

exec sp_addextendedproperty 'MS_DiagramPaneCount', 1, 'SCHEMA', 'dbo', 'VIEW', 'ProductWeeklyStatistics'
go

grant select on ProductWeeklyStatistics to manager
go
